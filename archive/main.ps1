...
if ( 1 -eq $inpp1 )
{
    ...
    echo "1. 7-Zip" "2. Classic Shell" "3. Crystal Runtime" "4. InfranView" "5. Mozilla Firefox" "6. Microsoft Office" "7. Java Runtime Enviroment" "8. Java Development Kit" "9. NetPhone" "10. PDF24 Creator" "11. PDF-XChange" "12. Teamviewer Host" "13. Acriba" "14. David InfoCenter" "15. ESET" "16. Addison" "Go back with 'back'"
    $inpp2 = Read-Host -Prompt 'Input a number'
    cls
    if ( 1 -eq $inpp2 )
    {
    "$env:softinsta\7z1900-x64.exe"
    }
}